...
import { TwitterIcon, GithubIcon, LinkedInIcon, PinterestIcon, DribbbleIcon, SunIcon, MoonIcon, WhatsappIcon } from './Icons';
    ...
    return (
        ...
        >
          ...
          <nav>
                ...
                <CustomLink href="/articles" title="Feats" className='ml-4' />
            </nav>
            ...
            <nav className="flex items-center justify-center flex-wrap">
                ...
                <motion.a href="https://www.linkedin.com/in/naveen2908" target={"_blank"}
                    className="w-6 mx-3"
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                >
                ...
                <motion.a href="https://github.com/Naveee08" target={"_blank"}
                    className="w-6 mx-3"
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                >
                ...
                <motion.a href="https://api.whatsapp.com/send?phone=918489777443&text=Hello!" target={"_blank"}
                    className="w-6 mx-3"
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                >
...

          {
            ...
            <nav className='flex items-center flex-col justify-center'>
                  ...
                  <CustomMobileLink href="/articles" title="Feats" className='' toggle={handleClick} />
              </nav>

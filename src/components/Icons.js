...
export const WhatsappIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M380.9 97.1C339.2 55.4 283.8 32 224 32 100.3 32 0 132.3 0 256c0 45.1 11.5 89 33.5 128.1L3.2 480l101.1-29.5c37.9 20.7 80.7 31.5 119.7 31.5 123.7 0 224-100.3 224-224 0-59.8-23.4-115.2-65.1-157.9zm-156.9 337c-35.3 0-73.2-10.3-105.4-29.7l-7.6-4.5-60 17.5 17.7-58.4-4.9-7.9c-20.3-33.1-30.9-70.8-30.9-109.1C33.8 149.1 122.5 60.4 224 60.4c54.4 0 105.6 21.2 144.2 59.7s59.7 89.8 59.7 144.2c0 101.5-88.7 190.2-190.2 190.2zM306.6 318.7c-5.3-2.7-31.2-15.4-36-17.2-4.8-1.8-8.3-2.7-11.8 2.7-3.5 5.3-13.5 17.2-16.5 20.7-3 3.5-6 4-11.3 1.3-5.3-2.7-22.5-8.3-42.9-26.5-15.9-14.1-26.5-31.5-29.5-36.8-3-5.3-.3-8.2 2.4-10.9 2.5-2.5 5.3-6.6 8-9.9 2.7-3.3 3.6-5.5 5.3-9 1.7-3.5.8-6.6-.4-9.3-1.2-2.7-11.8-28.6-16.2-39.4-4.2-10.3-8.4-8.9-11.8-9-3-0.1-6.5-.1-10 .1-3.4.2-9.3 1.3-14.1 6.6-4.8 5.3-18.2 17.8-18.2 43.5s18.6 50.7 21.3 54.2c2.7 3.5 36.5 56 88.6 75.4 12.4 4.8 22.1 7.7 29.6 9.9 12.4 3.9 23.7 3.4 32.7 2.1 10-1.5 31.2-12.7 35.6-25.1 4.4-12.4 4.4-23 3.1-25.1-1.3-2.1-4.8-3.4-10-6.1z"
    />
  </svg>
);

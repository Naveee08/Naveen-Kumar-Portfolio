...
import profilePic from "../../public/images/profile/naveenn.png";
...
const about = () => {
    return (
        <>
            ...
            <Head>
                <title> Naveen Kumar | About Page</title>
                    ...
                    <AnimatedText text="Passion Fuels Purpose!" className="mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8" />         
                       <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        ...
                        bg-light p-8 dark:bg-dark dark:border-light xl:col-span-4 md:order-1 md:col-span-8 '>
                            ...
                            <Image src={profilePic} alt="Naveen Kumar" className='w-full h-auto rounded-2xl'
                                priority
                        ...
                        <div className=" col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3">
                            ...
                            <div className=" flex flex-col items-end justify-center xl:items-center">
                                ...
                                <h2 className=' text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm'>Satistied clients</h2>
                            </div>
